...
def initialize_mt5(login_id, password, server=None):
    ...
    print(f"Logged in to account #{account_info.login} with balance {account_info.balance}")
    return True
...
if __name__ == "__main__":
    ...
    MT5_LOGIN_ID = 12345678  # Replace with your trading account ID
    MT5_PASSWORD = "your_password"  # Replace with your trading account password
    MT5_SERVER = "your_server"  # Replace with your broker's server name (optional)

    if initialize_mt5(MT5_LOGIN_ID, MT5_PASSWORD, MT5_SERVER):
